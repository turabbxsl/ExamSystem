...
* **Audit Interceptor:** Implements `ISaveChangesInterceptor` to automatically manage `CreatedAt` and `UpdatedAt` timestamps for all entities, ensuring database consistency without manual boilerplate code.
